...
const { Artboard, Rectangle, Ellipse, Text, Color, Group, RootNode } = __webpack_require__(/*! scenegraph */ "scenegraph");
const NoteList = __webpack_require__(/*! ./components/NoteList */ "./src/components/NoteList.jsx");
...
class Note extends React.Component {
    ...
    copyNote() {
        ...
        let clipboard = __webpack_require__(/*! clipboard */ "clipboard");
    ...
    render() {
        ...
        return React.createElement(
            "div",
            { className: "closed", id: this.props.note.guid },
            React.createElement(
                "div",
                { className: "listNoteMeta" },
                React.createElement(
                    "div",
                    { className: "listNoteTitle", onClick: this.toggleNote },
                    React.createElement(
                        "h1",
                        null,
                        this.state.noteName
                ...
                React.createElement(
                    "div",
                    { className: "listNoteCopy", onClick: this.copyNote },
                    "Copy"
                )
            ),
            React.createElement(
                "div",
                { className: "back", onClick: this.toggleNote },
                "Back to Notes"
            ),
            React.createElement(
                "form",
                null,
                React.createElement("input", { type: "text", "uxp-quiet": "true", className: "noteTitle", defaultValue: this.state.noteName, onChange: this.handleTitleChange }),
                React.createElement("textarea", { "uxp-quiet": "false", className: "noteText", onChange: this.handleTextChange, value: this.state.noteText }),
                React.createElement(
                    "button",
...
const Note = __webpack_require__(/*! ../components/Note */ "./src/components/Note.jsx");
...
class NoteList extends React.Component {
  ...
  render() {
    let listItems = this.props.notes.map(note => {
      return React.createElement(
        'li',
        { key: note.guid, className: 'noteItem' },
...
__webpack_require__(/*! ./util/reactShim */ "./src/util/reactShim.js");

const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const ReactDOM = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");

const App = __webpack_require__(/*! ./App */ "./src/App.jsx");
const PanelController = __webpack_require__(/*! ./controllers/PanelController */ "./src/controllers/PanelController.js");

const specNotesPanel = new PanelController(App);

module.exports = {
    panels: {
        specNotes: specNotesPanel
    }
};

/***/ }),

/***/ "./src/util/reactShim.js":
/*!*******************************!*\
  !*** ./src/util/reactShim.js ***!
  \*******************************/
/*! no static exports found */
